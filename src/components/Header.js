                                    ...
                                    <div className="col-lg-8">
                                        <ul className="topbar-contact">
                                            ...
                                            <li>
                                                ...
                                                10 A, G Block ,Ashok Vihar Phase 2 , Gurgaon,122001
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <li>
                                        ...
                                        <div className="sub-menu">
                                            ...
                                            <div className="sub-menu-item">
                                                ...
                                                {/* <Link to="/Mobileappdevelopment"> */}
                                                <h4><a href="#Customsoftwaredevelopment">Custom Software Development
                                            ...
                                            <div className="sub-menu-item">
                                                {/* <Link to="/Webdevelopment"> */}
                                                {/* <Link to="/Mobileappdevelopment" params="#android"> */}
                                                <h4><a href="#test">
                                                    Windows Development
                                                    </a>
                                                </h4>
                                            ...
                                            <div className="sub-menu-item">
                                                {/* <Link to="/Webdevelopment"> */}
                                                {/* <Link to="/Mobileappdevelopment"> */}
                                                <h4><a href="#Tallycustomization">Tally Customization
                                                </a></h4>
                                                {/* </Link> */}
                                                {/* </Link> */}
                                                {/* <!--<ul style="visibility: hidden;>--> */}
                                            ...
                                            <div className="sub-menu-item">
                                                {/* <Link to="/Webdevelopment"> */}
                                                {/* <Link to="/Mobileappdevelopment"> */}
                                                <h4><a href="#Tallycustomization">Web Hosting
                                                </a></h4>
                                                {/* </Link> */}
                                                {/* </Link> */}
                                                {/* <!--<ul style="visibility: hidden;>--> */}
                                            ...
                                            <div className="sub-menu-item">
                                                ...
                                                <h4><a href="#Webhosting">Email Server
                                                </a></h4>
                                                {/* </Link> */}
                                                {/* <!--<ul style="visibility: hidden;>--> */}
                                                {/* <!--  <li><a href="php-development.php">PHP</a></li > --> */}
                                            ...
                                            <div className="sub-menu-item">
                                                ...
                                                <h4><a href="#Webhosting"> Maintenance and Support
                                                </a></h4>
                                                {/* </Link> */}
                                                {/* <!--<ul style="visibility: hidden;>--> */}
                                                {/* <!--  <li><a href="php-development.php">PHP</a></li > --> */}
                                            ...
                                            <div className="sub-menu-item">
                                                {/* <Link to="/Mobileappdevelopment"> */}
                                                <h4><a href="#Emailserver">Cloud Server
                                            ...
                                            <div className="sub-menu-item">
                                                {/* <Link to="/Webdevelopment"> */}
                                                {/* <Link to="/Mobileappdevelopment"> */}
                                                <h4><a href="#Maintenanceandsupports">Maintenanceandsuport
                                                </a></h4>
                                                {/* </Link> */}
                                                {/* </Link> */}
                                                {/* <!--<ul style="visibility: hidden;>--> */}
                                            ...
                                            <div className="sub-menu-item">
                                                {/* <Link to="/Webdevelopment"> */}
                                                {/* <Link to="/Mobileappdevelopment"> */}
                                                <h4><a href="#Softwaretestingandqualityassurance">Software Testing and Quality Assurance
s
                                                </a></h4>
                                                {/* </Link> */}
                                                {/* </Link> */}
